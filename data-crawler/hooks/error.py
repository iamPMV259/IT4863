...
class MissionCheckingError(_InternalError):
    """Custom exception for mission checking errors.

    Args:
        message (str): The error message describing the mission checking issue.
    """
